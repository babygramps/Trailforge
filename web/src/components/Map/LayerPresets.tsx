...
const BUILTIN_PRESETS: LayerPreset[] = [
  {
    ...
    layers: {
      ...
      cyclosm: { visible: false, opacity: 1 },
      "waymarked-hiking": { visible: true, opacity: 0.7 },
      "waymarked-cycling": { visible: false, opacity: 0.7 },
  ...
  },
  {
    ...
    layers: {
      ...
      osm: { visible: false, opacity: 1 },
      cyclosm: { visible: true, opacity: 1 },
      "waymarked-hiking": { visible: false, opacity: 0.7 },
      "waymarked-cycling": { visible: true, opacity: 0.7 },
      "my-tracks": { visible: true, opacity: 1 },
      waypoints: { visible: true, opacity: 1 },
    },
  },
  {
    id: "preset-topo-clean",
    name: "Topo Only",
    layers: {
      "topo-base": { visible: true, opacity: 1 },
      osm: { visible: false, opacity: 1 },
